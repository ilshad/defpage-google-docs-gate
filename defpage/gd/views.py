...
def default(req):
    if not req.user.authenticated:
        return render_to_response("defpage.gd:templates/frontpage/unauthenticated.pt",
                                  {"login_url":system_params.login_url,
                                   "signup_url":system_params.signup_url},
                                  request=req)
    return render_to_response("defpage.gd:templates/frontpage/authenticated.pt",
                              {}, request=req)
